      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-300">
              AI-powered obituary generation to honor and remember loved ones with dignity and respect.
            </p>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-neutral-700 text-center text-sm text-neutral-400">
          © {new Date().getFullYear()} Free AI Obituary Generator. All rights reserved.
        </div>
      </div>
    </footer>
  );
